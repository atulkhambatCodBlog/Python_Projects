...
lg_button=Button(st,text="Log-Out",font=("Time New Roman",10,"bold"),relief=RAISED,cursor="plus",command=logout)
lg_button.place(x=150,y=270,height=50,width=200)

st_button=Button(st,text="Shutdown",font=("Time New Roman",10,"bold"),relief=RAISED,cursor="plus",command=shutdown)
